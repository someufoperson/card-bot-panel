...
ФИО — приводи к формату "Фамилия Имя Отчество" (каждое слово с заглавной буквы, остальные строчные), независимо от того, как написано в исходнике: хоть капслок, хоть случайный регистр. Пример: "АЛипов МаКсИм ВИКТОРОВИЧ" → "Алипов Максим Викторович".
